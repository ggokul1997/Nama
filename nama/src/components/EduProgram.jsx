...
const LevelCard = ({ level, ages, coreFocus, programs, details, icon }) => (
    <Card 
        className="h-100 border-0 p-3 mb-4" 
        style={{ 
            borderRadius: '15px', 
            backgroundColor: LIGHT_GREEN_BG, // Light background tint for timeline cards
        }}
    >
        <Card.Body>
...
const EducationalPathwayDetail = () => {
    return (
            ...
            <Row>
                ...
                <Col lg={4}>
                    <Card className="shadow-sm p-4 sticky-top" style={{ top: '20px', borderRadius: '15px' }}>
                        ...
                        <Form>
                            {['Full Name', 'Email Address', 'Phone Number', 'Phone Number (Optional)'].map((label, index) => (
...
export default EducationalPathwayDetail;